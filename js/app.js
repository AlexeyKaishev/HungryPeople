(() => {
    ...
    function initSliders() {
        if (document.querySelector(".specialties__slider")) new core(".specialties__slider", {
    ...
    let buttonScroll = document.querySelector(".scroll-restaurant__button");
    let block = document.querySelector(".about");
    let blockHeight = block.offsetHeight;
    buttonScroll.onclick = function(b) {
        window.scrollBy({
            left: 0,
            top: blockHeight,
            behavior: "smooth"
